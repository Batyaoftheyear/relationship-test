(() => {
  ...
  function getQuadrantProfile(result, xProfile, yProfile) {
    ...
    const descriptions = {
      'Гибкое партнёрство': `Ваш результат ближе к гибкому партнёрству. В этой позиции отношения скорее воспринимаются как область, где люди могут договариваться, менять способы взаимодействия и влиять на динамику через собственные действия. ${getCenterNuance(result)}`,
